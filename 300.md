<a id="readme-top"></a>
# GPT-4o Image Prompts · 201-349

🎉 欢迎来到 GPT‑4o 图片提示词（Prompts）201-349 案例合集！

这里收录了最新的 201-349 号案例，结构与主仓保持一致，可单独查阅或配合脚本生成 JSON 数据集。
...
**提示词：**
```
Creative surreal portrait of a woman sitting on the floor wearing a brown hoodie, ripped black pants, and boots, surrounded by several miniature versions of herself. Several smaller versions stand on her hands, shoulders, and around her on the floor, interacting playfully with the larger version. The light gray background is minimalist, clean, and simple. The lighting is soft and cinematic, with realistic shadows and depth of field.
```
