<a id="readme-top"></a>
# GPT-4o Image Prompts · 201-384

🎉 欢迎来到 GPT‑4o 图片提示词（Prompts）201-384 案例合集！

这里收录了最新的 201-384 号案例，结构与主仓保持一致，可单独查阅或配合脚本生成 JSON 数据集。

<a id="prompt-toc"></a>
## 📖 案例目录
*   [案例 384：鱼眼镜头自拍与动漫角色](#prompt-384)
*   [案例 383：图像修复与增强](#prompt-383)
*   [案例 382：皮克斯/梦工厂风格3D角色](#prompt-382)
*   [案例 381：辛普森一家风格角色](#prompt-381)
*   [案例 380：悬浮月牙上的优雅肖像](#prompt-380)
*   [案例 379：900粉丝感谢贴纸](#prompt-379)
*   [案例 378：3D可爱贴纸网格](#prompt-378)
*   [案例 377：生日蛋糕上的微型角色](#prompt-377)
*   [案例 376：多国美女亲密合影](#prompt-376)
*   [案例 375：鱼眼镜头自拍与动漫角色](#prompt-375)
*   [案例 374：粉彩涂鸦风格肖像](#prompt-374)
*   [案例 373：卡通角色玩具展示场景](#prompt-373)
*   [案例 372：街头涂鸦墙坐姿肖像](#prompt-372)
*   [案例 371：数字营销招聘形象](#prompt-371)
*   [案例 370：复古怀旧艺术感](#prompt-370)
*   [案例 369：叶雕艺术人像 ](#prompt-369)
*   [案例 368：巨型浴室中的小头女孩 ](#prompt-368)
*   [案例 367：医疗专业形象照 ](#prompt-367)
*   [案例 366：现代创新形象照 ](#prompt-366)
*   [案例 365：创意专业形象照 ](#prompt-365)
*   [案例 364：学术专业形象照 ](#prompt-364)
*   [案例 363：商务专业形象照 ](#prompt-363)
*   [案例 362：漫展同姿易拉宝与真人coser](#prompt-362)
*   [案例 361：查理和劳拉风格角色转换](#prompt-361)
*   [案例 360：黑白色调亚洲女性肖像](#prompt-360)
*   [案例 359：黑白戏剧光影亚洲女性肖像](#prompt-359)
*   [案例 358：影棚蕾丝深V时尚肖像](#prompt-358)
*   [案例 357：雪地孤独感三分构图肖像](#prompt-357)
*   [案例 356：影棚戏剧光时尚肖像](#prompt-356)
...
<a id="prompt-374"></a>
## 案例 374：粉彩涂鸦风格肖像 (来源 [Twitter](https://twitter.com/AIwithkhan/status/1984967699706106209))

<img src="./images/374-1.jpg" width="300" alt="Awesome GPT4o/GPT-4o Image Prompts-粉彩涂鸦风格肖像">
<img src="./images/374-2.jpg" width="300" alt="Awesome GPT4o/GPT-4o Image Prompts-粉彩涂鸦风格肖像">

**提示词：**
```
A vibrant, playful digital illustration of a young woman with voluminous curly hair, rendered in a style that resembles a chalkboard drawing mixed with colorful, whimsical handwritten doodles and stickers. The overall aesthetic should evoke a sense of positive, free-spirited energy, with elements like 'Curly Queen,' 'Hello there!', a rainbow, a smiling sun, and various arrows and abstract shapes surrounding her. The background has a textured, recycled paper feel.
```

---

<a id="prompt-373"></a>
## 案例 373：卡通角色玩具展示场景 (来源 [Twitter](https://t.co/RNs3OrURbK))

<img src="./images/373.png" width="300" alt="Awesome GPT4o/GPT-4o Image Prompts-卡通角色玩具展示场景">

**提示词：**
```
Create a hyper-realistic cinematic portrait of the same person from the reference photo. The person should keep their real facial features, hairstyle, skin tone, and clothing. They stand confidently at the center of a detailed and imaginative toy-style scene.

The concept resembles a highly detailed collectible action figure display: the person is surrounded by famous cartoon and pop culture characters. Include Goku from Dragon Ball (in his orange gi, glowing aura effect), Spider-Man posing dynamically, Scooby-Doo standing beside them, Tom and Jerry interacting playfully near their feet, Bugs Bunny and Daffy Duck on one side, and a few Pokémon (like Pikachu, Charizard, and Bulbasaur) adding color and energy to the scene.

The base (pedestal) should look artistic and elaborate, inspired by toy collections or action figure dioramas - detailed textures, miniature props, and references to each character's universe.

Lighting & atmosphere: Warm cinematic lighting with soft shadows, slightly glowing highlights that make the scene look like a premium collectible statue under a display spotlight. The environment feels cozy and magical, mixing realism and fantasy with depth of field and realistic reflections.

Camera setup: Eye-level shot with slightly wide framing to capture both the person and the characters around them. High detail, ultra-realistic materials, subtle background blur, 8K quality.
```

**中文提示词：**
```
创建一张与参考照片中相同人物的超写实电影级肖像。该人物应保持其真实面部特征、发型、肤色和服装。他们自信地站在一个精细且富有想象力的玩具风格场景中心。

概念类似于高度精细的可收藏动作公仔展示：该人物被著名的卡通和流行文化角色包围。包括龙珠的悟空（穿着橙色练功服，带有光环效果）、动态摆姿势的蜘蛛侠、站在他们旁边的史酷比、在他们脚边嬉戏互动的汤姆和杰瑞、一边的兔八哥和达菲鸭，以及一些宝可梦（如皮卡丘、喷火龙和妙蛙种子）为场景增添色彩和活力。

底座（基座）应看起来艺术且精致，灵感来自玩具收藏或动作公仔立体模型——精细纹理、微型道具，以及每个角色宇宙的参考。

光线与氛围：温暖的电影级光线，柔和阴影，微微发光的高光，使场景看起来像在展示灯光下的高级收藏雕像。环境感觉舒适而神奇，混合现实主义和幻想，具有景深和真实反射。

相机设置：平视拍摄，略微宽框架以捕捉该人物和他们周围的角色。高细节、超写实材料、微妙背景模糊、8K质量。
```

<a id="prompt-372"></a>
## 案例 372：街头涂鸦墙坐姿肖像 (来源 [@NanoBanana_labs](https://x.com/NanoBanana_labs/status/1984142292937281949))

<div style="display: flex; justify-content: space-between;">
<img src="./images/372-1.jpeg" style="width: 32%;" alt="Awesome GPT4o/GPT-4o Image Prompts-街头涂鸦墙坐姿肖像">
<img src="./images/372-2.jpeg" style="width: 32%;" alt="Awesome GPT4o/GPT-4o Image Prompts-街头涂鸦墙坐姿肖像">
<img src="./images/372-3.jpeg" style="width: 32%;" alt="Awesome GPT4o/GPT-4o Image Prompts-街头涂鸦墙坐姿肖像">
</div>

**提示词：**
```
Create an image of the man (use the face photo as reference, Keep face of person 100% accurate from the reference image), sitting on a graffiti-covered concrete wall, wearing an oversized white T-shirt with a funny face print loosely tucked into gray jogger pants, white socks, and black Vans Old Skool shoes. Shot from a dramatic low angle, with the shoe sole sharply dominating the foreground, clearly showing the waffle pattern. The other leg hangs casually over the edge of the wall. The background features a street mural with the words "GRAFFITI TEXT HERE" in striking colors — blue, yellow, and orange — set against a bright blue sky with scattered white clouds, giving an outdoor urban vibe. Natural daylight lighting, balanced and crisp, showing realistic textures on the clothing, shoes, and graffiti wall. Streetwear editorial aesthetic with strong wide-angle lens distortion, realistic colors, high detail, 4:5 aspect ratio, cinematic style inspired by Dougshineon. Atmosphere & Style: - Cinematic photography, ultra-realistic - Adventurer, luxury travel, exotic experience vibe - 8K resolution, studio-quality photo
```

**中文提示词：**
```
创建一张这位男性的图像（使用面部照片作为参考，保持人物面部100%准确），他坐在涂鸦覆盖的混凝土墙上，穿着印有趣味面孔图案的超大白色T恤，松散地塞进灰色慢跑裤，白色袜子，和黑色Vans Old Skool鞋子。以戏剧性的低角度拍摄，鞋底清晰占据前景，清楚展示华夫饼纹路。另一条腿随意地挂在墙边。背景是街头壁画，上面写着"GRAFFITI TEXT HERE"，采用醒目的颜色——蓝色、黄色和橙色——背景是明亮的蓝天和零散的白云，营造户外城市氛围。自然日光照明，平衡且清晰，展示服装、鞋子和涂鸦墙的真实纹理。街头服装编辑美学，强烈的广角镜头畸变，逼真的色彩，高细节，4:5宽高比，受Dougshineon启发的电影风格。氛围与风格：-电影摄影，超逼真 -冒险家，奢华旅行，异国体验氛围 -8K分辨率，工作室品质照片
```

<a id="prompt-371"></a>
## 案例 371：数字营销招聘形象 (来源 [@ShreyaYadav___](https://x.com/ShreyaYadav___/status/1984650126133248088))

<img src="./images/371.jpeg" width="300" alt="Awesome GPT4o/GPT-4o Image Prompts-数字营销招聘形象">

**提示词：**
```
Edit this image to show an innovative professional woman in a creative thinking pose with one hand touching her chin thoughtfully, other hand holding a laptop open at waist level, standing in a three-quarter stance with an enthusiastic visionary expression. She's wearing a modern electric blue blazer over a casual white henley shirt for creative professional appeal. The background is pristine white fading to soft mint green gradient. Digital marketing visual elements float around her: social media platform icons (Instagram, LinkedIn, Facebook, TikTok logos) in their signature colors, minimalist megaphone graphics, ascending analytics chart symbols, engagement icons like hearts and comment bubbles, target/bullseye symbols, and at-sign symbols. Colorful metric badges showing growth numbers (+2.5k, +850). Connecting lines and nodes between icons suggest integrated campaigns. Small lightning bolt and star accents in blue and green add creative energy. The left side displays compelling typography: "WE'RE HIRING" with bold, modern sans-serif font in vibrant gradient colors.
```

**中文提示词：**
```
编辑这张图片，展示一位创新的专业女性摆出创意思考姿势，一只手优雅地触摸下巴，另一只手在腰部位置托着打开的笔记本电脑，以四分之三姿势站立，表情充满热情和远见。她穿着现代电蓝色西装外套，内搭休闲白色亨利衫，展现创意专业魅力。背景为纯净白色渐变至柔和薄荷绿色。数字营销视觉元素围绕她漂浮：社交媒体平台图标（Instagram、LinkedIn、Facebook、TikTok标志）采用其标志性颜色，简约扩音器图形，上升的分析图表符号，参与度图标如爱心和评论气泡，目标/靶心符号，以及@符号。彩色指标徽章显示增长数字（+2.5k, +850）。图标之间的连接线和节点暗示整合营销活动。蓝色和绿色的小闪电和星星点缀增添创意能量。左侧展示引人注目的排版："WE'RE HIRING"采用大胆现代的无衬线字体，色彩鲜艳渐变。
```
...
<div style="display: flex; justify-content: space-between;">
<img src="./images/370-1.png" style="width: 48%;" alt="复古怀旧光感的女性人像，柔和自然光与胶片颗粒效果">
<img src="./images/370-2.png" style="width: 48%;" alt="低饱和米棕色调的复古女性肖像，优雅姿态与柔和阴影">
</div>

**提示词：**
```
Based on the uploaded image, generate an image using the facial features from the uploaded image. This image utilizes soft natural light to create a warm and tranquil atmosphere. Low saturation tones and film grain effects add a retro and nostalgic artistic feel. In composition, the subject dominates the frame with dynamic curves and a pose full of feminine charm, with natural and intimate eye contact with the viewer. The use of light and shadow is exquisite, highlighting skin texture and body contours, especially the shadow details at the neckline and legs, adding depth to the image. From a designer's perspective, the image balances comfort and sensuality in visual communication. The main colors of beige and light brown provide a soft and minimalist visual feel, suitable for home, fashion, or lifestyle design themes. The subject's attire and posture emphasize casual relaxation, conveying a "private, leisurely" life scenario. The grain and aged effects serve as texture design elements to enhance the overall style, making it more personalized and story-driven. Overall, it is a highly emotional and stylized portrait work.
```

**中文提示词：**
```
基于上传的照片生成新图像，保持原图中的面部特征一致。画面使用柔和自然光营造温暖宁静的氛围，低饱和配色与胶片颗粒强化复古怀旧的艺术感。构图中人物充满动态曲线与女性魅力，主体占据画面，与观者保持自然亲密的目光交流。巧妙运用光影突出皮肤质感与身体轮廓，特别强调颈线与腿部阴影层次，增强画面深度。从设计角度看，应在视觉传达中平衡舒适感与性感。主色调以米色和浅棕为主，营造柔和极简的视觉体验，适用于家居、时尚或生活方式主题。人物服饰与姿态强调随性放松，传达'私享、悠闲'的生活情境。颗粒与做旧效果作为纹理设计元素提升整体风格的个性与叙事感，呈现富有情绪与风格化的肖像作品。
```

<a id="prompt-369"></a>
## 案例 369：叶雕艺术人像 (来源 [@ShreyaYadav___](https://x.com/ShreyaYadav___/status/1982273721340678274))
<img src="./images/369.jpeg" width="300" alt="Awesome GPT4o/GPT-4o Image Prompts-叶雕艺术人像">
**提示词：**
```
Create an artwork of leaf carving art made from a dried, oval-shaped leaf, featuring precisely carved details that form a portrait or object based on the reference in my photo. Additionally, include the text "Yadav" carved elegantly along the upper curve of the leaf. The leaf is intricately carved so that light passes through the delicate patterns on its surface. The carving result reveals a realistic and detailed silhouette. The background shows a natural landscape with a bright blue sky, green trees, or natural cliffs. The focus is sharp on the leaf, with a soft bokeh background, warm natural lighting, high realism, and a macro photography style.
```
<a id="prompt-368"></a>
## 案例 368：巨型浴室中的小头女孩 (来源 [@ShreyaYadav___](https://x.com/ShreyaYadav___/status/1982140087443095742))
<img src="./images/368.jpeg" width="300" alt="Awesome GPT4o/GPT-4o Image Prompts-巨型浴室中的小头女孩">
**提示词：**
```
Ultra realistic photorealistic capture of a young woman with a tiny head in a giant bathroom, struggling comically. Keep uploaded face consistent and unchanged. She is actively washing her face and brushing her teeth in a sink that looms too large, standing precariously on an oversized tube of toothpaste. Her hand grasps a toothbrush the size of herself, creating a struggle to reach her teeth, while water dramatically splashes across her face and slightly messy hair. A funny, surprised expression, as if water has splashed unexpectedly into her eyes, conveys genuine emotion amidst her loose t-shirt and cute cartoon shorts. Her hair is styled in a high bun or with small, brightly colored clips, illuminated by gentle morning sunlight streaming through a clean window, casting soft ambient light and natural shadows across the scene. Shot on an 85mm lens at f/2.0, this professional photography piece features high resolution, natural color grading with a subtle film look, detailed textures, and a photorealistic quality, emphasizing her authentic struggle and expressions, with a 2:3 aspect ratio.
```
<a id="prompt-367"></a>
## 案例 367：医疗专业形象照 (来源 [@cheerselflin](https://x.com/cheerselflin/status/1982030831834300801))

<img src="./images/367.png" width="300" alt="Awesome GPT4o/GPT-4o Image Prompts-医疗专业形象照">

**提示词：**
```
Edit this image. I need a professional, high-resolution, profile photo, maintaining the exact facial structure, identity, and key features of the person in the input image. The subject is framed from the chest up, with ample headroom and negative space above their head, ensuring the top of their head is not cropped. The person looks directly at the camera with a trustworthy, compassionate expression, and the subject's body is positioned directly facing the camera with excellent posture. They are styled for a professional photo studio shoot, wearing a crisp white medical coat over a light blue collared shirt. The background is a solid '#141414' neutral studio. Shot from a high angle with bright and airy soft, diffused studio lighting, gently illuminating the face and creating a subtle catchlight in the eyes, conveying a sense of expertise and care. Captured on an 85mm f/1.8 lens with a shallow depth of field, exquisite focus on the eyes, and beautiful, soft bokeh. Observe crisp detail on the fabric texture of the medical coat, individual strands of hair, and natural, realistic skin texture，keep the glass if the picture has .. The atmosphere exudes confidence, trustworthiness, and medical professionalism. Clean and bright cinematic color grading with subtle warmth and balanced tones, ensuring a polished and contemporary feel.
```
<a id="prompt-366"></a>
## 案例 366：现代创新形象照 (来源 [@cheerselflin](https://x.com/cheerselflin/status/1982030831834300801))

<img src="./images/366.png" width="300" alt="Awesome GPT4o/GPT-4o Image Prompts-现代创新形象照">
...
<a id="prompt-362"></a>
## 案例 362：漫展同姿易拉宝与真人coser (来源 [@Tz_2022](https://twitter.com/Tz_2022/status/1971639248584352230))

<div style="display: flex; justify-content: space-between; flex-wrap: wrap; gap: 8px;">
<img src="./images/362-1.jpg" style="width: 48%;" alt="漫展现场，coser与 roll-up 易拉宝同姿势合影示例1">
<img src="./images/362-2.jpg" style="width: 48%;" alt="漫展现场，coser与 roll-up 易拉宝同姿势合影示例2">
<img src="./images/362-3.jpg" style="width: 48%;" alt="漫展现场，coser与 roll-up 易拉宝同姿势合影示例3">
<img src="./images/362-4.jpg" style="width: 48%;" alt="漫展现场，coser与 roll-up 易拉宝同姿势合影示例4">
<img src="./images/362-5.jpg" style="width: 48%;" alt="漫展现场，coser与 roll-up 易拉宝同姿势合影示例5">
<img src="./images/362-6.jpg" style="width: 48%;" alt="漫展现场，coser与 roll-up 易拉宝同姿势合影示例6">
<img src="./images/362-7.jpg" style="width: 48%;" alt="漫展现场，coser与 roll-up 易拉宝同姿势合影示例7">
<img src="./images/362-8.jpg" style="width: 48%;" alt="漫展现场，coser与 roll-up 易拉宝同姿势合影示例8">
</div>

**提示词：**
```
Scene: An anime/game convention hall. A life-size vertical roll-up banner (85×200cm, visible aluminum base with feet and top clamp bar, matte anti-glare finish) stands on the left, displaying the original character from the uploaded reference image. A real human cosplayer stands on the right, wearing an exact replica costume that perfectly matches the banner character (precise match of hairstyle, hair color, outfit details, accessories, props), striking the same pose as the banner (not mirrored). Background shows bokeh crowd and convention booths.

Camera settings: 45mm focal length, f/3.2 aperture, eye-level slight low angle, full-body framing, shallow depth of field, sharp subjects with bokeh background.

Lighting: Soft convention expo lighting, neutral color temperature.

Quality: Cinematic quality, 4K resolution, realistic photography style.

Negative prompt: easel, foam board, tabletop poster, text, logos, mirrored pose, different outfit, extra limbs, hand deformation, blurry, overexposed

```

**中文提示词：**
```
场景：动漫游戏展会大厅，一个真人大小的竖版易拉宝（85×200cm，铝制底座和顶杆可见，哑光防眩光材质）立在左侧，展示上传图片中的角色原版形象。右侧站着一位真人Coser，穿着与易拉宝上角色完全一致的服装（精确匹配发型、发色、服装细节、配饰、道具），摆出与易拉宝相同的姿势（不镜像）。背景是虚化的展会人群和摊位。

相机参数：45mm焦距，f/3.2光圈，平视略低角度，全身框架，浅景深，主体清晰背景虚化。

光线：柔和的展会照明，自然色温。

质量要求：电影级画质，4K分辨率，真实摄影风格。

负面提示词：画架，泡沫板，桌面海报，文字，Logo，镜像姿势，不同服装，多余肢体，手部畸形，模糊，过曝

```
**提示词 1：**
```
[Subject] A professional photographic work showing a cosplay scene at an anime/game convention

[Layout]
- Left: Vertical roll-up banner (85×200cm), fully visible including base stabilizer feet, rear tension pole, aluminum top clamp bar
- Right: Full-body shot of real human cosplayer, small gap from banner
- Banner content: Character from uploaded reference image, edge-to-edge borderless print, 200-micron PET matte film

[Cosplayer Requirements]
- Costume: Exact 1:1 replica of banner character (hair parting, bang length, garment cut, color blocking, lace patterns, accessory placement, footwear)
- Pose: Perfectly synchronized with banner (limb angles, weight shift, head tilt, gaze direction, finger shapes) in same orientation, NOT mirrored
- Props: All props must be present, held in same hand and orientation as banner
- Makeup: Convention-ready professional makeup
- Wig: Precise match of character hair color and style

[Environment]
- Location: Indoor exhibition hall
- Background: Medium bokeh crowd and booth backdrops, no legible text
- Lighting: Convention softboxes plus overhead lighting, neutral white balance

[Camera Technical Parameters]
- Focal length: 45mm (portrait standard)
- Aperture: f/3.2 (shallow DoF)
- Angle: Eye-level with 5-10 degree low tilt
- Framing: Full-body composition ensuring complete banner from base to top bar
- Depth of field: Sharp subjects, soft bokeh background
- Color: Cinematic grading, neutral tones

[Quality Control]
- Resolution: 4K
- Style: Documentary photography
- Sharpness: Maximum priority, no motion blur
- Color management: Strict lock to character's original palette

[Negative Prompt]
easel, tripod easel, foam board, white border poster, tabletop poster, standee cutout, curling edges, brand logos, legible text, alternate outfit, redesign, style variation, blindfold, sunglasses, maid dress, apron, missing props, wrong color scheme, different hairstyle, wig color mismatch, different pose, mirrored pose, extra limbs, hand deformation, blurry banner, overexposed, duplicated subjects
```
**提示词中文 1：**
```
【主体】一张专业摄影作品，展示动漫/游戏展会现场的Cosplay场景

【布局】
- 左侧：竖版易拉宝（85×200cm），完整可见包括底座稳定脚、后置张力杆、顶部铝制夹杆
- 右侧：真人Coser全身像，与易拉宝保持小间隙
- 易拉宝内容：上传参考图中的角色，无边框满版印刷，200微米PET哑光膜

【Coser要求】
- 服装：1:1精确还原易拉宝角色（发型分线、刘海长度、服装剪裁、颜色分块、蕾丝图案、配饰位置、鞋款）
- 姿势：与易拉宝完全同步（肢体角度、重心偏移、头部倾斜、视线方向、手指形态）保持一致，禁止镜像
- 道具：所有道具必须出现，持握手和朝向与易拉宝一致
- 化妆：展会级专业妆容
- 假发：精确匹配角色发色和发型

【环境】
- 地点：室内展览馆
- 背景：中等虚化的人群和展位背景墙，无可辨识文字
- 光线：展会柔光箱+顶部照明，中性白平衡
...
【负面提示词】
画架、三脚架画架、泡沫板、白边海报、桌面海报、立牌、边缘卷曲、品牌Logo、可辨文字、替代服装、重新设计、风格变体、眼罩、太阳镜、女仆装、围裙、缺失道具、错误配色、不同发型、假发颜色不符、不同姿势、镜像姿势、多余肢体、手部畸形、易拉宝模糊、过曝、主体重复
```

<a id="prompt-361"></a>
## 案例 361：查理和劳拉风格角色转换 (来源 [@ShreyaYadav___](https://twitter.com/ShreyaYadav___/status/1980847374324162682))

<div style="display: flex; justify-content: space-between; flex-wrap: wrap; gap: 8px;">
<img src="./images/361.jpeg" style="width: 48%;" alt="查理和劳拉风格角色转换">
</div>

**提示词：**
```
Transform the subject from the uploaded image into a character in the style of Charlie and Lola (children's cartoon). Match the official cartoon look — thin sketchy outlines, flat colors, childlike proportions, playful hand-drawn charm, and simple textures.Retain the subject's original clothing, hairstyle, facial features, accessories, skin tone, pose, and expression — but reinterpret them as if they belong in the Charlie and Lola world. plain white background to keep the focus on the character
```

**中文提示词：**
```
将上传图片中的主题转换为查理和劳拉（儿童卡通）风格的角色。匹配官方卡通外观——细线轮廓、平面色彩、儿童比例、俏皮手绘魅力和简单纹理。保留主题原有的服装、发型、面部特征、配饰、肤色、姿势和表情——但重新诠释它们，仿佛它们属于查理和劳拉的世界。纯白色背景以保持焦点在角色上
```

<a id="prompt-360"></a>
## 案例 360：黑白色调亚洲女性肖像 (来源 [@IamEmily2050](https://twitter.com/IamEmily2050/status/1980627079315222769))

<div style="display: flex; justify-content: space-between; flex-wrap: wrap; gap: 8px;">
<img src="./images/360-1.jpg" style="width: 48%;" alt="黑白色调影棚肖像，亚洲女性低头沉思，黑色V领上衣">
</div>

**提示词：**
```
A soft black and white studio portrait of an East Asian woman with dark hair in a loose, slightly messy updo, with strands framing her face. Her head is gently bowed, eyes cast downwards, conveying quiet contemplation. She wears a black ribbed V-neck cardigan or top, revealing a subtle silver necklace with an intricate pendant. Soft, diffused, ethereal lighting from above and behind creates a luminous halo around her hair and shoulders, gently highlighting her face and décolletage. The background is a smooth, gradient grey, creating a serene, uncluttered setting. The mood is gentle, serene, and introspective.
```

**中文提示词：**
```
一张柔和的黑白影棚肖像，一位东亚女性，深色头发松散地挽成一个略显凌乱的发髻，几缕发丝垂落脸颊。她头部轻微下倾，目光向下，流露出沉静的思索。她穿着一件黑色罗纹V领开衫或上衣，隐约可见一条带有精致吊坠的银色项链。柔和、漫射、空灵的光线从上方和后方投射，在她头发和肩膀周围形成一圈 luminous 光晕，轻柔地照亮她的脸庞和颈部。背景是平滑的渐变灰色，营造出宁静、整洁的氛围。整体情绪温柔、安宁、内省。
```

<a id="prompt-359"></a>
## 案例 359：黑白戏剧光影亚洲女性肖像 (来源 [@MANISH1027512](https://twitter.com/MANISH1027512/status/1980278681927877032))

<div style="display: flex; justify-content: space-between; flex-wrap: wrap; gap: 8px;">
<img src="./images/359-1.jpg" style="width: 48%;" alt="黑白戏剧光影亚洲女性肖像，深V领黑色上衣，左侧强光照明">
<img src="./images/359-2.png" style="width: 48%;" alt="黑白戏剧光影亚洲女性肖像，深V领黑色上衣，左侧强光照明">
</div>
...
**中文提示词：**
```
迷人的黑白特写肖像，美丽年轻亚洲女性，肌肤无瑕，短发波波头配齐刘海，双眼轻闭长睫毛微翘，微撅的嘴唇，宁静内省的表情，身穿修身深V领黑色罗纹针织衫突显身材，佩戴细巧项链带小吊坠，左侧戏剧性侧光在脸部、颈部和肩部创造强烈阴影和高光，高对比度明暗对比风格，极简主义影棚背景，从浅到深的柔和渐变，照片级真实，复古胶片颗粒效果，高细节，情感和神秘氛围。
```
...
**中文提示词2：**
```
一个女人自信地站在极简主义工作室中，从略低的视角拍摄，半身肖像，她头部略微向下倾斜，表情平静而神秘，中分麻花辫，几缕松散的发丝垂落在脸庞，微妙的湿发质感，身穿紧身黑色无袖连衣裙和黑色皮手套，双手松散地在身体前方拿着一条皮带——戏剧性的主光从右上角射入，高对比度，黑白影调，强烈的轮廓光勾勒出她的曲线，纯粹的纹理墙背景，电影黑色氛围，艺术时尚摄影，受赫尔穆特·牛顿和彼得··库尔森启发，浅景深，平滑渐变，优雅而强大的氛围
```

<a id="prompt-358"></a>
## 案例 358：影棚蕾丝深V时尚肖像 (来源 [@cnyzgkc](https://twitter.com/cnyzgkc/status/1980469269134733415))

<div style="display: flex; justify-content: space-between; flex-wrap: wrap; gap: 8px;">
<img src="./images/358-1.jpg" style="width: 23%;" alt="柔和灰背景下，身穿白色深V蕾丝礼服的女性正面站立，影棚柔光塑造立体阴影">
<img src="./images/358-2.jpg" style="width: 23%;" alt="高定晚礼服女性侧身摆姿，低盘发与戏剧光影彰显时尚质感">
<img src="./images/358-3.png" style="width: 23%;" alt="柔和灰背景下，身穿白色深V蕾丝礼服的女性正面站立，影棚柔光塑造立体阴影">
<img src="./images/358-4.png" style="width: 23%;" alt="高定晚礼服女性侧身摆姿，低盘发与戏剧光影彰显时尚质感">
</div>
...
**中文提示词：**
```
超细节、照片级真实的美丽女性肖像，高级时尚杂志风格。白色深V蕾丝亮片晚礼服，优雅的低发髻盘发，柔和的影棚灯光，浅灰背景，戏剧性的光影对比，超现实质感，8K。
```

<a id="prompt-357"></a>
## 案例 357：雪地孤独感三分构图肖像 (来源 [@NanoBanana_labs](https://twitter.com/NanoBanana_labs/status/1975123090012065859))

<div style="display: flex; justify-content: space-between; flex-wrap: wrap; gap: 8px;">
<img src="./images/357-1.jpg" style="width: 48%;" alt="纵向三分构图的年轻男子在雪中撑伞，表情忧郁孤独">
</div>

**提示词：**
```
Create a photo of a young man (keep the original face). Use a vertical frame — size 2160x3840 pixels (4K quality) — divided into three equally sized horizontal sections placed together as a continuous composition. The main character is based on the reference (keep the original face). He is portrayed as a young figure with an expression of sadness and nostalgia, his deep eyes radiating loneliness. He wears a dark outfit that contrasts with the cold surroundings. First image: He stands while holding a dark umbrella, his expression filled with quiet sadness. Second image: His face is tilted upward, eyes distant, capturing a mood of deep loneliness. Third image: He faces the camera directly, his eyes conveying pain and melancholy. The overall atmosphere is blanketed in white snow, with a cold, muted color palette that evokes melancholy and solitude.
```

**中文提示词：**
```
创作一幅年轻男子的照片（保持原始面孔），画面为竖版2160x3840像素（4K 质量），由三个等高的横向画面拼接成一个连续构图。主角参考提供的面孔，呈现年轻、忧伤怀旧的状态，深邃的眼神透露孤独。他穿着深色服装，与冰冷环境形成对比。第一幅：他撑着深色雨伞站立，神情静默悲伤；第二幅：他抬头望向上方，目光遥远，传递深深的孤独；第三幅：他正视镜头，眼神中充满痛楚与忧郁。整体场景被白雪覆盖，采用冷冽低饱和的色调，营造孤寂与凄清的氛围。
```

<a id="prompt-356"></a>
## 案例 356：影棚戏剧光时尚肖像 (来源 [@hellokaton](https://twitter.com/hellokaton/status/1980121853474791580))

<div style="display: flex; justify-content: space-between; flex-wrap: wrap; gap: 8px;">
<img src="./images/356-1.jpg" style="width: 48%;" alt="黑白戏剧光下的女性背对镜头站立，背景有水平光束切割">
<img src="./images/356-2.jpg" style="width: 48%;" alt="橙蓝对比灯光照射下的女性侧脸肖像，眼睛闭合，抬头沐浴光线">
<img src="./images/356-3.jpg" style="width: 48%;" alt="现代感椅子上坐姿女性，在粉紫色几何光影背景中展现时尚气质">
<img src="./images/356-4.jpg" style="width: 48%;" alt="全白服装女性坐姿持白玫瑰，夕阳投影照亮白色影棚背景">
</div>

**提示词 1：**
```
A dramatic black-and-white studio portrait. The subject stands with her back to the camera, upper body gently turned to the side, head slightly bowed so only a slice of the profile is visible. Her expression stays calm and introspective, evoking a quiet, mysterious mood. Lighting: one intense side light carving high contrast, plus a clean horizontal beam slicing across the backdrop. Most of the frame remains in shadow, emphasizing silhouette and contour. Atmosphere: minimalist, moody, cinematic, blending elegance with solitude. She wears a dark jacket that melts into the shadows for a sleek editorial look. Shot on a full-frame body with an 85 mm lens at f/1.8, ISO 200, 1/125 s. Mid-shot framing from waist to head to highlight the outline, profile, and pose. Post: high-contrast black-and-white grade, gentle tonal roll-off, deep shadows, and light film grain for a polished art-magazine finish.
```

**中文提示词 1：**
```
一张戏剧性的黑白工作室肖像照。主体背对镜头站立，上半身轻微转向侧面，头微微低下，脸部侧面轮廓部分可见。表情平静而内省，营造出一种安静、神秘的氛围。 灯光：一盏强烈的侧光，投下鲜明的对比。一束干净的水平光束横切过背景墙。画面大部分处于阴影之中，着重强调剪影和轮廓。 氛围：极简主义，情绪化，电影感，唤起优雅与孤独感。主体身穿深色夹克，与阴影融为一体，呈现出流畅利落的时尚杂志风格。 构图：使用全画幅相机拍摄，85mm镜头，f/1.8大光圈营造浅景深效果，ISO 200，快门速度1/125秒。中景构图（从腰部到头部），突出剪影、侧脸和姿态。 后期：高对比度的黑白效果，柔和的色调渐变，深邃的阴影，添加轻微的胶片颗粒以增加质感，最终呈现精致的艺术杂志风格。
```

**提示词 2：**
```
A cinematic side-profile portrait of a young woman tilting her head back with eyes closed, bathed in dramatic light. She stands against a deep blue studio backdrop wearing a black blazer. A warm spotlight drops in from the upper right, painting orange highlights across her face and neck while cooler blue shadows wrap the background, creating vivid color contrast. Keep the lighting clean, with soft gradients and a minimalist set. Aim for an artistic, modern, high-impact editorial vibe. Camera: side angle, slight low tilt, 85 mm portrait lens with shallow depth of field. Lighting: dramatic studio setup with strong contrast, blue backlight plus warm key spot. Mood: emotive, cinematic, minimalist.
```

**中文提示词 2：**
```
一张富有电影感的年轻女子侧脸肖像，她仰着头，闭着眼睛，沐浴在戏剧性的光线中。 她站在深蓝色的背景前，穿着一件黑色西装外套。一束暖色聚光灯从右上角照下，在她的脸部和颈部投下橙色的光晕，在冷蓝色的阴影和温暖的高光之间形成了强烈的对比。 整个构图强调情绪和氛围，拥有干净的影棚灯光、柔和的渐变和极简主义的氛围。图像应具有艺术感、现代感和强烈的视觉冲击力，类似于高端杂志的编辑摄影风格。 相机角度： 侧面拍摄，微仰角 光线： 戏剧性的影棚布光，强对比度，蓝色背光 + 暖色聚光灯 镜头： 85毫米人像镜头，浅景深 氛围： 情绪化，电影感，极简主义
```

**提示词 3：**
```
A stylish cinematic portrait of a young woman seated indoors on a modern chair. Compose at a three-quarter angle with her body gently leaning back and one arm draped casually over the chair, projecting calm confidence. Preserve the reference hairstyle, oval face, and defined jawline. Outfit: all-black fashion look—dark turtleneck and structured blazer—for a high-end editorial ensemble. Background: smooth dark wall lit by window geometry casting soft magenta-lavender light patterns. Colored light should graze the wall and subtly rim-light her hair and shoulders to heighten drama. Keep lighting moody yet elegant with soft shadows and cinematic contrast. Grade for deep blacks, natural skin, and vibrant pink highlights—no text, logos, or watermarks. Subject sits slightly off-center.
```
...
**提示词 4：**
```
Create a studio portrait using the provided woman's face. Shoot from the front against a white backdrop, with her seated on a chair. Wardrobe: all-white ensemble—blazer, skirt, and heels. Pose her elegantly with one hand supporting her chin while holding a small white rose. Let soft sunset window projections fall across the studio wall to add warmth and depth.
```

**中文提示词 4：**
```
请在影楼里拍摄一张照片，照片中使用所附照片中的女性面孔。 拍摄角度为正面，白色影楼背景，女性坐在椅子上。 她身穿全套白色服装：白色西装外套、白色裙子和白色高跟鞋。 姿势优雅，手托下巴，手里拿着一小枝白色玫瑰。 影楼墙壁上投射着柔和的夕阳窗户光线。
```
...
<a id="prompt-375"></a>
## 案例 375：鱼眼镜头自拍与动漫角色 (来源 [Twitter](https://twitter.com/ecommartinez/status/1983892304621662607))
<img src="./images/375.jpg" width="300" alt="Awesome GPT4o/GPT-4o Image Prompts-鱼眼镜头自拍与动漫角色">
**提示词：**
```
Ultra-realistic selfie in vertical 9:16 format with fisheye lens of me with (Sonic and Mario). Set in a small, bright living room with white tones. High camera angle. Extreme fisheye distortion. Realistic and cinematic lighting. Anime characters integrated with stylized realism.
```

**中文提示词：**
```
超写实自拍，垂直9:16格式，使用鱼眼镜头拍摄我与（索尼克和马里奥）。场景设定在白色调的小而明亮的客厅中。高角度拍摄。极端鱼眼畸变。写实且电影感的灯光。动漫角色以风格化的写实主义融入。
```


<a id="prompt-376"></a>
## 案例 376：多国美女亲密合影 (来源 [Twitter](https://x.com/songguoxiansen/status/1984954144101458143))
<img src="./images/376.jpg" width="300" alt="Awesome GPT4o/GPT-4o Image Prompts-多国美女亲密合影">
**提示词：**
```
Photoshop a long-haired white-haired Israeli young beauty, Photoshop a long-haired blonde Russian young beauty, Photoshop a long-haired black-haired Korean young beauty, Photoshop a long-haired red-haired American young beauty, they have intimate poses with the man in the photo.
```

**中文提示词：**
```
图片中ps一个长发白发以色列年轻美女，PS一个长发金发俄罗斯年轻美女，ps一个长发黑发的韩国年轻美女，PS一个长发红发的美国年轻美女，她们和照片中的男人有亲昵的姿势。
```

<a id="prompt-377"></a>
## 案例 377：生日蛋糕上的微型角色 (来源 [Twitter](https://twitter.com/Arminn_Ai/status/1985462330977583602))
<img src="./images/377.jpg" width="300" alt="Awesome GPT4o/GPT-4o Image Prompts-生日蛋糕上的微型角色">
**提示词：**
```
A hyper-realistic conceptual photo of [PERSON FROM UPLOADED PHOTO]. The character appears miniaturized and sits naturally on the edge of a fully sliced vanilla birthday cake on a clean tabletop. The cake has soft sponge layers with cream and jam, topped with powdered sugar and fresh raspberries. A single lit candle stands in the middle of the cake, its warm glow gently illuminating the character. Pose: casual, one leg hanging over the slice gap, the other bent; gaze toward the camera with a calm, warm, reflective expression. The entire cake is visible, centered on a plate. Macro depth of field: shallow focus on both cake and character with a softly blurred background. Perfect scale integration, accurate contact, and natural shadows. Lighting: bright, soft, evenly diffused studio light plus subtle candle reflections. Background: neutral indoor blur (creamy beige or light gray). Style/quality: photorealistic conceptual food art; as if shot on a Canon EOS 5D, 85mm f/1.8. Shallow DOF, crisp detail, smooth falloff. Eye-level tabletop framing, medium close-up. Warm-toned cinematic grading, fine atmospheric details—visible food texture, micro sugar granules, soft shadows.
```

**中文提示词：**
```
一张超写实概念照片，[上传照片中的人物]。角色被微型化，自然地坐在干净桌面上一块完全切开的香草生日蛋糕边缘。蛋糕有柔软的蛋糕层，夹着奶油和果酱，顶部撒有糖粉和新鲜覆盆子。一支点燃的蜡烛立在蛋糕中央，其温暖的光芒轻轻照亮角色。姿势：休闲，一条腿悬在切片间隙上，另一条腿弯曲；目光朝向相机，表情平静、温暖、沉思。整个蛋糕可见，放在盘子中央。微距景深：蛋糕和角色都有浅焦，背景柔和模糊。完美的比例整合、准确的接触和自然阴影。灯光：明亮、柔和、均匀漫射的影棚灯光加上微妙的蜡烛反光。背景：中性室内模糊（奶油米色或浅灰色）。风格/质量：写实概念美食艺术；如同用佳能EOS 5D、85mm f/1.8拍摄。浅景深，清晰细节，平滑过渡。眼平桌面构图，中近景。暖色调电影级调色，精细氛围细节——可见的食物纹理、微糖颗粒、柔和阴影。
```

<a id="prompt-378"></a>
## 案例 378：3D可爱贴纸网格 (来源 [Twitter](https://twitter.com/ShreyaYadav___/status/1985738257708302430))
<img src="./images/378.jpg" width="300" alt="Awesome GPT4o/GPT-4o Image Prompts-3D可爱贴纸网格">
**提示词：**
```
...
**中文提示词：**
```
创建一个3D可爱10:16画布，包含九个chibi风格的贴纸，穿着不同的服装、摆出不同的姿势和表情。使用附件图片作为参考。每个贴纸都有白色边框，并包含带有短语的对话气泡，如"Goodmorning"、"Lunch kana"、"Huh"、"Hugs"、"Thank you"、"Goodnight"、"You're the best"、"miss you"、"mwah 😙"、"good job"和"Ingat ka"。设置在柔和的白色到淡蓝色渐变背景上，营造有趣、积极的氛围。
```

<a id="prompt-379"></a>
## 案例 379：900粉丝感谢贴纸 (来源 [Twitter](https://twitter.com/Owa_Knight/status/1985773397809512627))
<img src="./images/379.jpg" width="300" alt="Awesome GPT4o/GPT-4o Image Prompts-900粉丝感谢贴纸">
**提示词：**
```
Subject: cheerful 3D cartoon girl with long dark hair, white flower hair clip, expressive brown eyes, soft rounded features; wearing a mix of cute outfits (white off-shoulder top, yellow sweater, purple tee, green dress, blue pajamas, coral shirt, pink blazer); each pose conveys emotions like waving, hugging, clapping, sleeping, and giving a thumbs up Setting: bright neutral background in a 3×3 grid sticker layout, each labeled with phrases — "Goodmorning," "Lunch kana," "Huh?," "Hugs," "Thank you," "Goodnight," "You're the best," "miss you," and "good job"; with an elegant overlay at the top center reading "Thank You 900 Followers" in a friendly, modern font Lighting: soft diffuse daylight, balanced exposure emphasizing 3D shading and gloss Camera: straight-on, symmetrical framing, close-up shot for detail clarity Style: kawaii 3D emoji-sticker illustration, modern gratitude aesthetic Color Palette: warm and pastel tones — cream, blush pink, sage green, sky blue, peach, ivory Quality: ultra-detailed, high-resolution, photorealistic 3D render Reference: uploaded face Negative Prompt: distorted text, blur, watermark, overexposure, bad anatomy
```

**中文提示词：**
```
主题：快乐的3D卡通女孩，长黑发，白色花朵发夹，富有表情的棕色眼睛，柔软圆润的面部特征；穿着各种可爱服装（白色露肩上衣、黄色毛衣、紫色T恤、绿色连衣裙、蓝色睡衣、珊瑚色衬衫、粉色西装外套）；每个姿势传达不同的情感，如挥手、拥抱、鼓掌、睡觉和竖起大拇指 设置：明亮的背景，3×3网格贴纸布局，每个贴纸标有短语——"Goodmorning"、"Lunch kana"、"Huh?"、"Hugs"、"Thank you"、"Goodnight"、"You're the best"、"miss you"和"good job"；顶部中央有优雅覆盖层，显示"Thank You 900 Followers"，使用友好现代字体 灯光：柔和漫射的日光，平衡曝光，强调3D阴影和光泽 相机：正面拍摄，对称构图，特写镜头以获得细节清晰度 风格：可爱3D表情贴纸插画，现代感恩美学 色彩调色板：温暖和柔和的色调——奶油色、腮红粉、鼠尾草绿、天蓝色、桃色、象牙色 质量：超详细、高分辨率、写实3D渲染 参考：上传的面部 负面提示：扭曲的文本、模糊、水印、过度曝光、不良解剖结构
```

<a id="prompt-380"></a>
## 案例 380：悬浮月牙上的优雅肖像 (来源 [Twitter](https://twitter.com/SimplyAnnisa/status/1985983317699936593))
<div style="display: flex; justify-content: space-between;">
<img src="./images/380-1.jpg" style="width: 48%;" alt="Awesome GPT4o/GPT-4o Image Prompts-悬浮月牙上的优雅肖像">
<img src="./images/380-2.jpg" style="width: 48%;" alt="Awesome GPT4o/GPT-4o Image Prompts-悬浮月牙上的优雅肖像">
</div>
**提示词：**
```
Use the uploaded photo as facial reference — preserve every facial feature exactly, with no alterations. Realistic portrait photoshoot in a studio, a happy and graceful young woman wearing soft pastel pyjamas, sitting elegantly on a glowing suspended half-crescent moon. The scene is viewed from a low angle, surrounded by dreamy white clouds resting gently on the studio floor. Gentle warm lighting with a slight haze effect creates an ethereal and cinematic atmosphere.
```

**中文提示词：**
```
使用上传的照片作为面部参考——精确保留每个面部特征，不做任何改动。影棚写实肖像拍摄，一位快乐优雅的年轻女子穿着柔和的淡色睡衣，优雅地坐在发光的悬浮半弯月上。场景从低角度观看，周围是梦幻的白云轻轻落在影棚地板上。柔和温暖的灯光带有轻微的雾霾效果，营造出空灵和电影般的氛围。
```

<a id="prompt-381"></a>
## 案例 381：辛普森一家风格角色 (来源 [Twitter](https://twitter.com/aleenaamiir/status/1985634042109444580))
<img src="./images/381.jpg" width="300" alt="Awesome GPT4o/GPT-4o Image Prompts-辛普森一家风格角色">
**提示词：**
```
Full-body caricature of the characters in the picture in The Simpsons style, featuring iconic yellow skin tone, large expressive eyes with black pupils, and a slightly exaggerated overbite. Hair and clothing rendered in flat, clean colors with bold outlines and subtle shading for depth. Facial features stylized but recognizable, with clear lines for eyebrows, mouth, and nose. Dynamic pose showing personality, full body visible, balanced proportions, and lively gestures. Background is a classic Springfield-inspired scene with cartoon-style houses, trees, and soft gradient sky, warm pastel tones, and simple but engaging environment. Bright, vibrant, and playful colors, with polished clean lines and consistent Simpsons-style charm.
```

**中文提示词：**
```
图片中角色的全身漫画化，采用辛普森一家风格，具有标志性的黄色肤色、带有黑色瞳孔的大而有表现力的眼睛，以及略微夸张的龅牙。头发和服装采用平面、干净的颜色渲染，带有粗轮廓线和微妙的阴影以增加深度。面部特征风格化但可识别，眉毛、嘴巴和鼻子有清晰的线条。动态姿势展现个性，全身可见，比例平衡，手势生动。背景是经典的斯普林菲尔德风格场景，有卡通风格的房屋、树木和柔和的渐变天空，温暖的柔和色调，简单但引人入胜的环境。明亮、鲜艳和俏皮的颜色，带有抛光干净的线条和一致的辛普森风格魅力。
```

**示例图片：**
<div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 10px; margin-top: 20px;">
<img src="./images/381-1.jpg" style="width: 100%;" alt="Example 1">
<img src="./images/381-2.jpg" style="width: 100%;" alt="Example 2">
<img src="./images/381-3.jpg" style="width: 100%;" alt="Example 3">
<img src="./images/381-4.jpg" style="width: 100%;" alt="Example 4">
<img src="./images/381-5.jpg" style="width: 100%;" alt="Example 5">
<img src="./images/381-6.jpg" style="width: 100%;" alt="Example 6">
<img src="./images/381-7.jpg" style="width: 100%;" alt="Example 7">
<img src="./images/381-8.jpg" style="width: 100%;" alt="Example 8">
</div>

<a id="prompt-382"></a>
## 案例 382：皮克斯/梦工厂风格3D角色 (来源 [Twitter](https://twitter.com/aleenaamiir/status/1985634042109444580))
<div style="display: flex; justify-content: space-between;">
<img src="./images/382-1.png" style="width: 48%;" alt="Awesome GPT4o/GPT-4o Image Prompts-皮克斯/梦工厂风格3D角色">
<img src="./images/382-2.png" style="width: 48%;" alt="Awesome GPT4o/GPT-4o Image Prompts-皮克斯/梦工厂风格3D角色">
</div>
**提示词：**
```
Full-body 3D caricature of the characters in the picture, rendered in the iconic Pixar/DreamWorks animation style.

Emphasis on Facial Details (to maximize likeness):

Eyes: Expressive and large, with detailed irises, glossy highlights in the pupils, and subtle crow's feet at the corners that crinkle with their smiles to enhance expression.
Head & Features: A slightly oversized head to accentuate expressions. Subtly exaggerated facial features that stay true to the original character's likeness.
Skin Texture: Realistic skin with visible fine pores and soft subsurface scattering for a warm, life-like glow. Include faint, natural laugh lines around the mouth and eyes.
Smile: A gentle, warm, and genuine smile.
Hair & Eyebrows: Highly detailed, with individual strands visible, creating a soft and realistic look.
Body & Scene:

Pose: A dynamic, full-body pose that showcases their personality, with balanced and appealing proportions. Full body must be visible.
Clothing: Smooth, polished surfaces with realistic and subtle fabric textures.
Lighting & Background: Soft, cinematic ambient lighting that casts gentle shadows. A simple, warm reddish-orange gradient background.
Overall Quality:

Cinematic quality, ultra-high detail, vibrant yet natural color palette, and a perfect blend of stylized charm and balanced realism.
```

**中文提示词：**
```
将图片中的角色转换为全身3D漫画化，采用标志性的皮克斯/梦工厂动画风格。

面部细节强调（最大化相似度）：

眼睛：富有表现力且大，具有详细的虹膜，瞳孔中有光泽高光，眼角有细微的鱼尾纹，随着微笑而皱起以增强表情。
头部和特征：略微过大的头部以突出表情。微妙夸张的面部特征，保持原始角色相似度。
皮肤纹理：逼真的皮肤，可见细毛孔和柔和的次表面散射，呈现温暖、逼真的光泽。包括嘴和眼睛周围淡淡的自然笑纹。
微笑：温和、温暖和真诚的微笑。
头发和眉毛：高度详细，可见单独的发丝，创造柔软逼真的外观。
身体和场景：

姿势：动态的全身姿势，展示个性，具有平衡和吸引人的比例。全身必须可见。
服装：光滑、抛光的表面，具有逼真和微妙的织物纹理。
灯光和背景：柔和、电影般的环境光，投射柔和的阴影。简单的暖红橙色渐变背景。
整体质量：

电影级质量，超高细节，鲜艳而自然的色彩调色板，以及风格化魅力和平衡写实主义的完美融合。
```

**替代提示词：**
```
Transform the characters in the picture into Full-body 3D caricature in Pixar/DreamWorks style, featuring expressive large eyes, slightly oversized head, and subtly exaggerated facial features. Realistic skin with soft subsurface scattering, detailed hair, and a gentle warm smile. Smooth polished surfaces with subtle fabric texture on clothing. Dynamic pose showing personality, with full body visible and balanced proportions. Soft ambient lighting, warm reddish-orange gradient background. Cinematic quality, high detail, vibrant yet natural colors, stylized charm with balanced realism.
```

**替代中文提示词：**
```
将图片中的角色转换为皮克斯/梦工厂风格的全身3D漫画化，具有富有表现力的大眼睛、略微过大的头部和微妙夸张的面部特征。逼真的皮肤带有柔和的次表面散射、详细的头发和温和温暖的微笑。服装上光滑抛光的表面带有微妙的织物纹理。动态姿势展示个性，全身可见且比例平衡。柔和的环境光，暖红橙色渐变背景。电影级质量，高细节，鲜艳而自然的颜色，风格化魅力与平衡写实主义。
```

<a id="prompt-383"></a>
## 案例 383：图像修复与增强 (来源 [Twitter](https://twitter.com/aleenaamiir/status/1985634042109444580))
<div style="display: flex; justify-content: space-between;">
<img src="./images/383-1.png" style="width: 48%;" alt="Awesome GPT4o/GPT-4o Image Prompts-图像修复与增强">
<img src="./images/383-2.png" style="width: 48%;" alt="Awesome GPT4o/GPT-4o Image Prompts-图像修复与增强">
</div>
**提示词：**
```
Fixing damaged facial details and body parts with natural reconstruction
...
<a id="prompt-384"></a>
## 案例 384：鱼眼镜头自拍与动漫角色 (来源 [Twitter](https://twitter.com/ecommartinez/status/1983892304621662607))
<div style="display: flex; justify-content: space-between;">
<img src="./images/384-1.png" style="width: 48%;" alt="Awesome GPT4o/GPT-4o Image Prompts-鱼眼镜头自拍与动漫角色">
<img src="./images/384-2.png" style="width: 48%;" alt="Awesome GPT4o/GPT-4o Image Prompts-鱼眼镜头自拍与动漫角色">
</div>
**提示词：**
```
...
<a id="prompt-385"></a>
## 案例 385：越南传统服饰肖像 (来源 [Twitter](https://x.com/ShreyaYadav___/status/1987778015917645963))

<div style="display: flex; justify-content: space-between;">
<img src="./images/385.jpg" style="width: 98%;" alt="Awesome GPT4o/GPT-4o Image Prompts-越南传统服饰肖像">
</div>
...
**中文提示词：**
```
创建上传人物的超逼真面部（保留精确的真人面部和身体特征，不做任何修改）8K高分辨率超现实肖像，一位年轻优雅的越南女性穿着传统的白色丝绸yếm（越南传统肚兜）和长长的深绿色长裙。她微微倾斜地坐着，右手拿着一朵新鲜的白色莲花靠近右脸颊，手肘优雅地弯曲。左手轻轻放在大腿上。她的头微微向莲花倾斜，眼睛看着花朵，带着宁静梦幻的神情和淡淡的微笑。她的黑发盘成高高的波浪发髻，几缕纤细的发丝勾勒出她白皙明亮的脸庞。背景是渐变的橄榄绿色，带有柔和温暖的光晕，突出yếm的丝绸质感、精致的莲花花瓣和她光滑的皮肤。一个装满白色莲花的大花瓶放在附近一张精雕细刻的木桌上。电影级构图，背景虚化，超清晰细节，真实阴影，杰作，照片级逼真
```
